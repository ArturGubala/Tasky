...
interface EventRemoteDataSource {
    ...
    suspend fun createEvent(event: Event): Result<UpsertEventResponseDto, DataError.Network>
    suspend fun updateEvent(event: Event): Result<UpsertEventResponseDto, DataError.Network>
    suspend fun deleteEvent(id: String): EmptyResult<DataError.Network>
    suspend fun confirmUpload(eventId: String, confirmUploadRequest: ConfirmUploadRequest):
